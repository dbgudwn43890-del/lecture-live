...
export const metadata: Metadata = {
  title: "환불 정책 | Lecue",
  description: "Lecue 월간과 1회 결제 플랜(학기권·연간권·추가 충전)의 환불 기준을 안내합니다.",
};
...
export default function RefundPolicyPage() {
  return (
    ...
    >
      ...
      <section><h2>제2조 무료 체험</h2><div><p>카드 없는 무료 체험은 결제가 아니므로 환불 대상이 아닙니다. 무료 체험은 유료 구독으로 자동 전환되지 않습니다.</p></div></section>
      ...
      <section><h2>제4조 학기권·연간권·추가 충전</h2><div><p>학기권, 연간권, 추가 충전은 자동 갱신이 없는 일회성 결제이며, 환불 기준과 사용분 공제는 제1조와 동일하게 적용됩니다. 기존 구매분에는 당시의 지급량과 이용 기간이 적용됩니다.</p></div></section>
