...
const copy = {
  ko: {
    ...
    monthlyCredits: "매월 3,000크레딧 · 약 50시간",
    trial: "처음 결제수단을 등록하면 7일 동안 180크레딧을 여러 수업에 나눠 사용할 수 있습니다.",
    term: "Term",
    termPrice: "34,000원 / 4개월",
    termCredits: "12,000크레딧 · 약 200시간",
    semester: "Semester",
    semesterPrice: "42,000원 / 6개월",
    semesterCredits: "18,000크레딧 · 약 300시간",
    oneTime: "한 번 결제하며 자동 갱신되지 않습니다.",
    startTrial: "7일 무료로 시작",
    subscribe: "Monthly 시작",
    buyTerm: "Term 선택",
    buy: "Semester 선택",
  ...
  en: {
    ...
    monthlyCredits: "3,000 credits each month · about 50 hours",
    trial: "Add a payment method to use 180 credits across multiple lectures during the 7-day trial.",
    term: "Term",
    termPrice: "$25.99 / 4 months",
    termCredits: "12,000 credits · about 200 hours",
    semester: "Semester",
    semesterPrice: "$32.99 / 6 months",
    semesterCredits: "18,000 credits · about 300 hours",
