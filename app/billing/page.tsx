...
import { availablePlans, billingMode } from "../lib/billing-config";
...
export default async function BillingPage({ locale: specified }: { locale?: "ko" | "en" }) {
  ...
  return <BillingClient locale={locale} signedIn={Boolean(user)} mode={billingMode()} available={availablePlans()} account={account} />;
}
