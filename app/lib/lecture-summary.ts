...
export const SUMMARY_PROMPT = [
  "다음은 대학 강의 스크립트의 한 구간이다. 이 구간을 나중에 다른 모델이 읽고",
  "질문에 답할 수 있도록 압축하라. 사람이 읽을 산문이 아니라 색인이다.",
  "",
  "형식:",
  "TOPICS: 이 구간에서 다룬 주제를 쉼표로 구분해 나열",
  "TERMS: 등장한 전문용어·고유명사·기호를 쉼표로 구분해 나열 (강사가 정의한 말은 반드시 포함)",
  "POINTS: 한 줄에 하나씩 '- ' 로 시작. 주장·정의·인과·예시를 강사가 말한 순서대로.",
  "  정의는 정의된 말과 그 뜻을 한 줄에 같이 적는다. 숫자·연도·수식은 그대로 옮긴다.",
  "",
  "규칙: 없는 내용을 지어내지 않는다. 스크립트에 없는 배경 지식을 덧붙이지 않는다.",
  "받아쓰기 오류로 보이는 말은 고치지 말고 그대로 둔다. 인사말·잡담은 버린다.",
  "전체 1500자를 넘기지 않는다.",
].join("\n");
