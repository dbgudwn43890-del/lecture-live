    ...
    >
      ...
      <section>
        ...
        <div>
          ...
          <p>마이크 음성과, 온라인 강의에서 이용자가 직접 선택한 브라우저 탭의 오디오는 음성 인식 사업자에게 실시간으로 전송되며 Lecue는 음성 원본을 별도로 저장하지 않습니다. 탭 공유 화면은 강의를 보면서 질문할 수 있도록 Lecue 화면 안에 표시되며, 이용자 기기 안에서만 처리됩니다. Lecue 서버나 외부에 화면을 전송·저장하지 않으며, 선택한 탭의 제목·주소도 저장하지 않습니다.</p>
      ...
      <section>
        <h2>6. 쿠키와 선택 분석</h2>
        <p id="cookies"><a href="#cookies" data-analytics-settings>쿠키 설정</a></p>
        <div>
          <p>로그인 상태 유지와 보안을 위해 필수 인증 쿠키를 사용합니다. 브라우저에서 차단하면 로그인 기능이 동작하지 않을 수 있습니다.</p>
          <p>2026년 9월 13일 선택 분석 안내를 추가했습니다. 수집은 별도 동의 후 시작됩니다.</p>
          <p>선택 분석은 필수 약관·녹음 동의와 별개이며 기본은 거부입니다. 별도로 허용한 경우에만 Google Analytics·Google Ads로 가명 쿠키 식별자, 허용된 광고 클릭 ID, 페이지 종류, 인증된 신규 가입 및 기능 사용 이벤트를 보냅니다. 이메일·이름·Lecue 계정 ID·강의 세션 ID·강의 내용·질문·답변·스크립트·인증 토큰·민감한 URL 값은 전송하지 않습니다. Google Signals·맞춤 광고·리마케팅을 사용하지 않습니다. 랜딩 페이지·강의실 하단 메뉴 또는 개인정보처리방침의 ‘쿠키 설정’에서 언제든 거부하거나 철회할 수 있으며, 철회하면 이후 수집을 중단하고 해당 브라우저의 분석 쿠키를 삭제합니다. 거부해도 로그인과 제품 기능에 영향이 없습니다. 분석 쿠키는 최대 90일, 동의 선택은 최대 180일간 유지합니다. 철회 전에 Google이 받은 데이터까지 자동 삭제되는 것은 아닙니다. Google LLC는 미국 등 개인정보처리방침에 공개한 지역에서 선택 측정 정보를 처리하며, 보관 기간은 Analytics 속성 설정을 따릅니다.</p>
        </div>
      </section>
