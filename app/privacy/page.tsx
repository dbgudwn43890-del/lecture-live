    ...
    >
        ...
        <div className={styles.tableWrap}>
          <table>
            ...
            <tbody>
              ...
              <tr><td>강의 자료</td><td>이용자가 올린 강의 자료 PDF 원본과 그 추출 텍스트·색인</td><td>답변에 자료 내용 반영, 답변의 근거가 된 쪽을 화면에 표시</td><td>자료 업로드</td></tr>
      ...
      <section>
        ...
        <div>
          ...
          <p>이용자가 올린 강의 자료는 추출 텍스트와 색인뿐 아니라 PDF 원본도 비공개 저장소에 보관합니다. 답변이 근거로 삼은 쪽을 이용자가 직접 확인할 수 있게 하기 위한 것이며, 원본은 본인에게만 발급되는 단기 서명 주소로만 열립니다. 자료를 삭제하면 원본 파일도 함께 삭제합니다.</p>
