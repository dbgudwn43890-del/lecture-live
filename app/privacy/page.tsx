...
export const metadata: Metadata = {
  title: "개인정보처리방침 | Lecture Live",
  description: "Lecture Live가 개인정보와 강의 데이터를 처리하는 기준입니다.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage
      title="개인정보처리방침"
      description="Lecture Live는 계정 정보와 강의 데이터를 서비스 제공에 필요한 범위에서만 처리합니다. 현재 베타에서는 강의 기록을 서비스 데이터베이스에 저장하지 않습니다."
    >
      <section>
        <h2>1. 기본 원칙</h2>
        <div>
          <p>
            Lecture Live 운영자(이하 “운영자”)는 개인정보 보호법 등 관계 법령을 준수하며, 이용자가 어떤 정보가 왜 필요한지 알 수 있도록 이 방침을 공개합니다.
          </p>
          <ul>
        ...
        <div className={styles.tableWrap}>
          <table>
            ...
            <tbody>
              ...
              <tr><td>강의 이용</td><td>강의 제목, 실시간 스크립트, 질문, AI 답변, 검색 출처, 기록 시간</td><td>강의 기록·질문</td><td>서비스 이용 시</td></tr>
      ...
      <section>
        ...
        <div>
          <h3>현재 베타의 강의 기록</h3>
          <p>
            강의 제목, 스크립트, 질문과 답변은 현재 브라우저 메모리에서만 유지되며 새로고침하거나 탭을 닫으면 사라집니다. 음성 원본은 운영자 서버에 저장하지 않고 음성 인식 처리를 위해 Deepgram으로 실시간 전송합니다.
          </p>
          <h3>보유 기간</h3>
          <ul>
            <li>회원 계정: 회원 탈퇴 시까지. 탈퇴 처리와 백업 반영에 필요한 정보는 최대 30일 이내 삭제</li>
            <li>저장 기능 도입 후 강의 기록: 이용자가 삭제하거나 회원 탈퇴할 때까지</li>
      ...
      <section>
        ...
        <div>
          <p>
            서비스의 계정 인증, 음성 인식과 AI 답변을 위해 다음 사업자에게 처리를 위탁합니다. 데이터는 인터넷 암호화 통신으로 서비스 이용 시점에 전송됩니다.
          </p>
          <div className={styles.tableWrap}>
            <table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>계정 인증과 세션 관리: 이메일, 계정 식별자, 인증 로그</td>
                ...
                <tr>
                  ...
                  <td>AI 답변과 필요한 웹 검색: 질문 시점까지의 스크립트, 질문, 임의화된 안전 식별자</td>
                  <td>미국 등 OpenAI 처리 지역 / 기본 오용 방지 로그 최대 30일</td>
                  <td>질문 기능을 사용하지 않으면 거부 가능하나 AI 답변 이용 불가</td>
                </tr>
                <tr>
          ...
          <p>
            OpenAI Responses API 요청은 <code>store: false</code>로 전송합니다. 이는 응답 애플리케이션 저장을 끄지만, 별도 보존 제어 승인을 받지 않은 일반 API 계정에서는 안전·오용 방지 로그가 최대 30일 처리될 수 있습니다.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div>
          <ul>
            ...
            <li>장기 API 키의 브라우저 노출 금지와 음성 인식용 단기 토큰 사용</li>
