...
const content = {
  ko: {
    ...
    plans: [
      ...
      { name: "월간", time: "1개월", compareLabel: "프로모션 종료 후 예정가", comparePrice: "16,500원", price: "9,900원", priceNote: "/월", unit: "4,200크레딧 · 약 70시간", detail: "40% 프로모션 · 모든 기능 포함", billingPlan: "monthly" },
      { name: "집중 학기", time: "4개월", compareLabel: "프로모션 종료 후 예정가", comparePrice: "56,700원", price: "34,000원", priceNote: "/4개월", unit: "16,800크레딧 · 약 280시간", detail: "40% 프로모션 · 모든 기능 포함", featured: true, billingPlan: "term" },
      { name: "한 학기", time: "6개월", compareLabel: "프로모션 종료 후 예정가", comparePrice: "70,000원", price: "42,000원", priceNote: "/6개월", unit: "25,200크레딧 · 약 420시간", detail: "40% 프로모션 · 모든 기능 포함", billingPlan: "semester" },
    ],
    featured: "가장 많이 선택",
    ...
    faqs: [
      ...
      ["요금제 크레딧은 실제 대학 수업에 충분한가요?", "월간은 4,200크레딧, 4개월권은 16,800크레딧, 한 학기권은 25,200크레딧을 제공합니다. 1크레딧은 시작한 녹음 1분이며 한 번의 수업은 최대 3시간입니다."],
  ...
  en: {
    ...
    plans: [
      ...
      { name: "Monthly", time: "1 month", compareLabel: "Planned post-promotion price", comparePrice: "$13.29", price: "$7.99", priceNote: "/month", unit: "4,200 credits · about 70 hours", detail: "40% promotion · every feature included", billingPlan: "monthly" },
      { name: "Focused term", time: "4 months", compareLabel: "Planned post-promotion price", comparePrice: "$43.29", price: "$25.99", priceNote: "/4 months", unit: "16,800 credits · about 280 hours", detail: "40% promotion · every feature included", featured: true, billingPlan: "term" },
      { name: "Semester", time: "6 months", compareLabel: "Planned post-promotion price", comparePrice: "$54.99", price: "$32.99", priceNote: "/6 months", unit: "25,200 credits · about 420 hours", detail: "40% promotion · every feature included", billingPlan: "semester" },
    ],
    ...
    faqs: [
      ...
      ["Is the credit allowance enough for a real class schedule?", "Monthly includes 4,200 credits, the 4-month pass includes 16,800, and Semester includes 25,200. One credit is one started recording minute, and each lecture can run for up to 3 hours."],
