...
const content = {
  ko: {
    ...
    heroNote: "현재 베타는 카드 등록 없음 · 유료 출시 후 7일 무료 체험 제공",
    promises: [
      ["5초 이내", "말이 문단으로 이어집니다"],
    ...
    pricingDescription: "주 20~30시간 수업을 듣는 학생도 모자라지 않도록 월 120시간을 기준으로 잡았습니다. 모든 유료 상품에서 기록, 질문, 강의실 맥락과 필요한 검색을 그대로 제공합니다.",
    pricingNoCard: "7일 체험 · 별도 동의 후에만 자동결제",
    pricingPerSecond: "실제 녹음한 시간만 차감",
    pricingIncluded: "모든 기능·질문·필요한 검색 포함",
    pricingCta: "무료 베타 시작하기",
    plans: [
      { name: "첫 체험", time: "7일", price: "무료", unit: "수업 1회 · 최대 3시간", detail: "계정당 한 번 · 결제 전 언제든 취소" },
      { name: "월간", time: "1개월", price: "24,900원", unit: "강의 기록 120시간", detail: "별도 동의 후 월 자동 갱신", featured: true },
      { name: "한 학기", time: "5개월", price: "109,000원", unit: "강의 기록 600시간", detail: "한 번 결제 · 자동 갱신 없음" },
    ],
    featured: "출시 추천",
    ...
    faqs: [
      ...
      ["무료 체험이 끝나면 바로 결제되나요?", "아닙니다. 체험 중 결제 예정일, 24,900원, 월 결제 주기, 결제수단과 해지 방법을 다시 보여 드리고 별도로 유료 전환에 동의한 경우에만 결제됩니다. 동의하지 않거나 다음 결제 전에 취소하면 과금되지 않습니다."],
      ["요금제 시간은 실제 대학 수업에 충분한가요?", "월간은 120시간, 한 학기권은 5개월 동안 600시간을 제공합니다. 한 번의 수업은 최대 3시간이며 실제 녹음 시간만 계산합니다. 월간은 매달 갱신되고 한 학기권은 자동 갱신되지 않습니다."],
  ...
  en: {
    ...
    heroNote: "No card during beta · A 7-day trial at paid launch",
    promises: [
    ...
    pricingDescription: "The 120-hour monthly allowance is designed around a student's real 20–30 hour class week. Every paid option includes transcription, questions, classroom context, and needed search.",
    pricingNoCard: "7-day trial · charges only after separate consent",
    ...
    plans: [
      { name: "First try", time: "7 days", price: "Free", unit: "One lecture · up to 3 hours", detail: "Once per account · cancel before billing" },
      { name: "Monthly", time: "1 month", price: "$17.99", unit: "120 recording hours", detail: "Monthly renewal after separate consent", featured: true },
      { name: "Semester", time: "5 months", price: "$79", unit: "600 recording hours", detail: "One payment · no automatic renewal" },
    ],
    ...
    faqs: [
      ...
      ["Will I be charged as soon as the trial ends?", "Only if, during the trial, you separately accept the exact charge date, price, billing cycle, payment method, and cancellation terms. If you do not consent or cancel before billing, the trial simply ends without a charge."],
      ["Is the allowance enough for a real class schedule?", "Monthly includes 120 recording hours, and Semester includes 600 hours across five months. Each lecture can run for up to 3 hours and only active recording counts. Monthly renews each month; Semester does not renew automatically."],
