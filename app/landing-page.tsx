...
const content = {
  ko: {
    ...
    plans: [
      ...
      { name: "월간", time: "1개월", compareLabel: "프로모션 종료 후 예정가", comparePrice: "16,500원", price: "9,900원", priceNote: "/월", unit: "3,600크레딧 · 약 60시간", detail: "40% 프로모션", billingPlan: "monthly" },
      { name: "집중 학기", time: "4개월", compareLabel: "프로모션 종료 후 예정가", comparePrice: "56,700원", price: "34,000원", priceNote: "/4개월", unit: "14,400크레딧 · 약 240시간", detail: "40% 프로모션", featured: true, billingPlan: "term" },
      { name: "한 학기", time: "6개월", compareLabel: "프로모션 종료 후 예정가", comparePrice: "70,000원", price: "42,000원", priceNote: "/6개월", unit: "21,600크레딧 · 약 360시간", detail: "40% 프로모션", billingPlan: "semester" },
    ],
    featured: "가장 많이 선택",
  ...
  en: {
    ...
    plans: [
      ...
      { name: "Monthly", time: "1 month", compareLabel: "Planned post-promotion price", comparePrice: "$13.29", price: "$7.99", priceNote: "/month", unit: "3,600 credits · about 60 hours", detail: "40% promotion", billingPlan: "monthly" },
      { name: "Focused term", time: "4 months", compareLabel: "Planned post-promotion price", comparePrice: "$43.29", price: "$25.99", priceNote: "/4 months", unit: "14,400 credits · about 240 hours", detail: "40% promotion", featured: true, billingPlan: "term" },
      { name: "Semester", time: "6 months", compareLabel: "Planned post-promotion price", comparePrice: "$54.99", price: "$32.99", priceNote: "/6 months", unit: "21,600 credits · about 360 hours", detail: "40% promotion", billingPlan: "semester" },
    ],
