...
const content = {
  ko: {
    ...
    pricingDescription: "주 20시간 안팎의 정규 수업을 기준으로 월 80시간을 제공합니다. 모든 유료 상품에서 기록, 질문, 강의실 맥락과 필요한 검색을 그대로 제공합니다.",
    ...
    plans: [
      ...
      { name: "월간", time: "1개월", price: "19,900원", unit: "강의 기록 80시간", detail: "별도 동의 후 월 자동 갱신", featured: true },
      { name: "한 학기", time: "6개월", price: "99,000원", unit: "강의 기록 480시간", detail: "한 번 결제 · 자동 갱신 없음" },
    ],
    featured: "출시 추천",
    ...
    faqs: [
      ...
      ["무료 체험이 끝나면 바로 결제되나요?", "아닙니다. 체험 중 결제 예정일, 19,900원, 월 결제 주기, 결제수단과 해지 방법을 다시 보여 드리고 별도로 유료 전환에 동의한 경우에만 결제됩니다. 동의하지 않거나 다음 결제 전에 취소하면 과금되지 않습니다."],
  ...
  en: {
    ...
    pricingDescription: "The 80-hour monthly allowance is designed around a regular class load of about 20 hours a week. Every paid option includes transcription, questions, classroom context, and needed search.",
    ...
    plans: [
      ...
      { name: "Monthly", time: "1 month", price: "$14.99", unit: "80 recording hours", detail: "Monthly renewal after separate consent", featured: true },
      { name: "Semester", time: "6 months", price: "$69", unit: "480 recording hours", detail: "One payment · no automatic renewal" },
    ],
