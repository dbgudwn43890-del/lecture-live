...
const content = {
  ko: {
    ...
    heroNote: "카드 등록 없음 · 설치 없음 · 베타 기간 무료",
    promises: [
      ["5초 이내", "말이 문단으로 이어집니다"],
    ...
    pricingTitle: ["필요한 기간만,", "모든 기능 그대로."],
    pricingDescription: "기능을 요금제마다 나누지 않습니다. 출시 후에는 한 달, 한 학기, 1년 중 필요한 기간을 고르고, 현재 베타는 계속 무료로 이용할 수 있습니다.",
    pricingNoCard: "7일 체험은 카드 없음",
    pricingPerSecond: "실제 녹음한 시간만 차감",
    pricingIncluded: "모든 기능·질문·필요한 검색 포함",
    pricingCta: "무료 베타 시작하기",
    plans: [
      { name: "첫 체험", time: "7일", price: "무료", unit: "수업 1회 · 최대 3시간", detail: "가입 계정당 한 번" },
      { name: "월간", time: "1개월", price: "14,900원", unit: "강의 기록 12시간", detail: "기간 종료 후 직접 갱신" },
      { name: "한 학기", time: "5개월", price: "59,000원", unit: "월 환산 11,800원", detail: "기간 전체 기록 60시간", featured: true },
      { name: "연간", time: "12개월", price: "119,000원", unit: "월 환산 약 9,900원", detail: "기간 전체 기록 120시간" },
    ],
    featured: "학생 추천",
    ...
    faqs: [
      ...
      ["기간형 요금제는 어떻게 이용하나요?", "월간 12시간, 한 학기 60시간, 연간 120시간을 선택한 기간 안에서 사용합니다. 수업 1회는 최대 3시간이며 실제 녹음 시간만 계산합니다. 남은 시간은 기간 종료와 함께 만료되고 기간권은 자동 갱신되지 않습니다."],
  ...
  en: {
    ...
    heroNote: "No card · Nothing to install · Free throughout beta",
    promises: [
    ...
    pricingTitle: ["Pick the term.", "Keep every feature."],
    pricingDescription: "Every paid term includes the same product. Choose a month, a semester, or a year. The current beta remains free until paid service begins.",
    pricingNoCard: "No card for the 7-day trial",
    ...
    plans: [
      { name: "First try", time: "7 days", price: "Free", unit: "One lecture · up to 3 hours", detail: "Once per account" },
      { name: "Monthly", time: "1 month", price: "$12.99", unit: "12 recording hours", detail: "Renew manually at the end" },
      { name: "Semester", time: "5 months", price: "$49", unit: "$9.80 per month", detail: "60 recording hours total", featured: true },
      { name: "Annual", time: "12 months", price: "$89", unit: "$7.42 per month", detail: "120 recording hours total" },
    ],
    featured: "Student pick",
    ...
    faqs: [
      ...
      ["How do term plans work?", "Use 12 hours on Monthly, 60 on Semester, or 120 on Annual during the term. Each lecture can run for up to 3 hours. Only active recording counts, unused time expires with the term, and passes do not renew automatically."],
