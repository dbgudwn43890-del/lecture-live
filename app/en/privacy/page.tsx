  ...
  return (
    ...
    >
      ...
      <section><h2>3. Storage and audio</h2><div>
        ...
        <p>Microphone audio, and for online lectures the audio of the browser tab you choose yourself, is streamed to a speech-recognition provider. Lecue does not separately store the original audio. The screen video the browser hands over with a tab share is received inside the browser only and is never sent to Lecue’s servers or anyone else, nor stored. The chosen tab’s title and URL are not stored either.</p>
