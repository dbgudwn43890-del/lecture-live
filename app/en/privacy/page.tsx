    ...
    >
      ...
      <section><h2>5. Service providers and international transfers</h2><div>
        ...
        <div className={styles.tableWrap}><table><thead><tr><th>Recipient</th><th>Purpose and data</th><th>Location, time, and retention</th></tr></thead><tbody>
          ...
          <tr><td><a href="https://www.cloudflare.com/privacypolicy/" target="_blank" rel="noreferrer">Cloudflare, Inc.</a></td><td>Optional speech recognition: microphone audio</td><td className={styles.placeholder}>Processing locations required / while the feature is used / provider retention policy</td></tr>
