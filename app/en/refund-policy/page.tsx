...
export const metadata: Metadata = {
  ...
  description: "How refunds work for Lecue's Monthly subscription and one-time plans (Semester, Annual, Top-up).",
};
...
export default function EnglishRefundPolicyPage() {
  return (
    ...
    >
      ...
      <section><h2>4. Semester, Annual and Top-up</h2><div><p>Semester, Annual and Top-up are one-time purchases with no automatic renewal. The Section 1 refund window and usage deduction apply. Existing purchases retain their original entitlement and expiry.</p></div></section>
