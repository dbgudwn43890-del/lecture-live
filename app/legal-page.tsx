    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div>
          <p>{description}</p>
          <dl>
            <div><dt>{isEnglish ? "Written" : "작성일"}</dt><dd>{isEnglish ? "August 22, 2026" : "2026년 8월 22일"}</dd></div>
      ...
      <aside className={styles.draftNotice}>
        ...
        <p>
          {isEnglish
            ? "This draft reflects the current product and planned hour-pack pricing. Before launch, the operator's legal name, representative, address, registration details, support email, actual server region, and payment processor must be added."
            : "이 문서는 현재 구현과 예정된 기간권 정책을 반영한 운영 초안입니다. 공개 전 운영자 상호·대표자·주소·사업자등록번호·통신판매업 신고번호·문의 이메일, 실제 서버 리전과 결제대행사를 확정해야 합니다."}
        </p>
      </aside>
